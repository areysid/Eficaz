  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-3 px-4 flex flex-col md:flex-row items-end md:items-center justify-between gap-3 shadow-lg mt-16"
      >
      ...
      {/* Hero Carousel */}
      <section className="relative w-full h-[14vh] sm:h-[50vh] overflow-hidden bg-background md:bg-black flex items-center">
        <div
