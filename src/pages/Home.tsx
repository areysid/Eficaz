...
//   const yearsCount = useCountUp(10, 2000, startCount);
...
//         {/* About (your original Hero section with history) */}
...
//                   <div className="flex items-center justify-center space-x-8">
//                     <div className="text-center">
//                       <div className="text-3xl font-bold text-primary">{corporationsCount}+</div>
//                       <div className="text-sm text-muted-foreground">Multinational Corporations</div>
//                     </div>
//                     <div className="text-center">
//                       <div className="text-3xl font-bold text-accent">{yearsCount}+</div>
//                       <div className="text-sm text-muted-foreground">Years Experience</div>
//                     </div>
//                   </div>
//                   <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
...
//         {/* Upcoming Webinar Section (kept as is) */}
...
//         {/* Featured Course Section (kept as is) */}
//         <section className="py-20">
//         <div className="container">
//           <div className="text-center space-y-4 mb-12">
...
//         {/* Testimonials Section (kept as is) */}
//         <section className="py-20 bg-muted/30">
//         <div className="container">
//           <div className="text-center space-y-4 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                text: "Excellent and timely support from Neha and team. They are one of the best support we got.",
              },
              {
                name: "Rishika Lavra",
                initials: "RL",
                color: "bg-primary/10 text-primary",
                text: "Excellent service. Their professional approach, tailored solutions, and clear communication exceeded my expectations.",
              },
            ].map((t, i) => (
              <Card key={i} className="hover:shadow-md transition">
                <CardContent className="pt-6">
                  <div className="flex items-center space-x-2 mb-4">
                    <div
                      className={`w-10 h-10 ${t.color} rounded-full flex items-center justify-center`}
                    >
